  ...
  return (
    <section className="relative min-h-screen w-full bg-white px-4 py-8 text-black select-none sm:px-8 sm:py-10 lg:px-12 pixel-dots-bg">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        {/* ========================================================================= */}
        <div className="mb-8 flex flex-wrap items-center justify-between gap-3 border-b-2 border-black pb-4">
        ...
        <div className="mb-12 flex flex-col items-center text-center">
          {/* Eyebrow Tag */}
          <div className="inline-flex items-center gap-2 border-2 border-black bg-[#0c71c3] px-3.5 py-1 font-['Press_Start_2P',monospace] text-[9px] uppercase tracking-wider text-white shadow-[2px_2px_0px_#000000] sm:text-[10px]">
            <span>✦</span>
          ...
          {/* ======================================================================= */}
          <div className="relative mt-2 w-full max-w-5xl border-[3px] border-black bg-white p-5 shadow-[6px_6px_0px_#000000] sm:p-7">
        ...
        {/* ========================================================================= */}
        <div
          className="relative overflow-hidden border-[3px] border-black bg-white p-4 shadow-[6px_6px_0px_#000000] sm:p-6"
